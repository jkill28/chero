          ...
          return (
            ...
            >
              <div className={cn(
                ...
                <div className="flex sm:justify-between items-center sm:flex-row flex-col items-end">
                  <span className={cn(
                    "text-[14px] sm:text-[12px] font-bold",
                  ...
                  {balance !== undefined && (
                    <div className={cn(
                      "hidden sm:block text-[11px] font-black",
                      isToday
                        ? "text-white"
              ...
              {/* Mobile view lines */}
              <div className="flex sm:hidden flex-col gap-0 px-1 pb-1 overflow-hidden items-end">
                {balance !== undefined && (
                  <div className={cn(
